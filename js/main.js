...
function numToMoney(v, n) {
    ...
    if (v === '' || v === undefined) {
        ...
        var _split = (v + '').split(/(?=\.)/),
            ...
            a = _split2[0],
            _split2$ = _split2[1],
            b = _split2$ === undefined ? '' : _split2$;

        var x = a.length % 3;
        r = a.substr(0, x) + a.substr(x).replace(/(\d{3})/g, ',$1').substr(+!x);
        if (n) r += (+(0 + b)).toFixed(n).substr(1);else if (b) r += b.substr(0, fixed + 1);
    }
    if (ipt) {
        var st = -1;
        if (document.activeElement === ipt) {
            ...
            var l1 = r.length;
            var fix = l1 - l0;
            var s0 = ipt.selectionStart;
            var s1 = ipt.selectionEnd;
            if (point !== -1 && s0 > point) st = s0 - fix + (fix > 0 ? s0 === s1 ? s0 - point === fix && fix === 1 ? 0 : 1 : 2 : -1);else {
    ...
    computed: {
        val: {
            ...
            set: function set(v) {
                var fixed = this.fixed || 2;
                var val = this.value;
                var fix1 = v.replace(/[^0-9,.]/g, '');
                var fix2 = v.replace(/,/g, '');
                var fix3 = parseFloat(parseFloat(fix2).toFixed(fixed));
                var nan = isNaN(fix3);
...
var _input3 = __webpack_require__(7);
...
_vue2.default.component(_input4.default.name, _input4.default);
_vue2.default.component('x-money', _money2.default);
new _vue2.default({
    el: '#app',
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0), __webpack_require__(1), __webpack_require__(13).setImmediate))
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_money_vue__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_money_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_money_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_money_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_money_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_376641ac_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_money_vue__ = __webpack_require__(16);
var disposed = false
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_money_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_376641ac_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_money_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\money.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-376641ac", Component.options)
  } else {
    hotAPI.reload("data-v-376641ac", Component.options)
  }
...
var render = function() {
  ...
  return _c(
    "div",
    {
      ...
      class: {
        "is-disabled": _vm.disabled,
        "el-input-group el-input-group--append": !!_vm.$slots.append
      }
    },
    [
      _c("input", {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-376641ac", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_04c2046b_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_App_vue__ = __webpack_require__(18);
var disposed = false
var normalizeComponent = __webpack_require__(2)
/* script */
  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        [_c("template", { slot: "append" }, [_vm._v("RMB")])],
        2
      )
    ],
    1
